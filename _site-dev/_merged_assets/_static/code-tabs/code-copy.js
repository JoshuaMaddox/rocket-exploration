...
// node_modules/rocket-preset-code-tabs/components/code-copy.css
var styles2 = i`:host {
...
`;
var code_copy_default = styles2;

// node_modules/rocket-preset-code-tabs/components/code-copy.ts
...
CodeCopy.styles = [button_host_default, code_copy_default];
CodeCopy.shadowRootOptions = {
  mode: "open",
  delegatesFocus: true
};
CodeCopy.copyIcon = T`
...
__decorateClass([
  r4()
], CodeCopy.prototype, "host", 2);
__decorateClass([
  r4()
], CodeCopy.prototype, "success", 2);
__decorateClass([
  e4({ type: Number })
], CodeCopy.prototype, "timeout", 2);
