  ...
  "node_modules/bind-decorator/index.js"(exports) {
    ...
    function bind(target, propertyKey, descriptor) {
      ...
      return {
        ...
        get: function() {
          var bound2 = descriptor.value.bind(this);
...
var import_bind_decorator = __toModule(require_bind_decorator());
  ...
  class MixedSelectMixinElement extends FireMixin(superclass) {
    ...
    onKeydown(event) {
      if (event.defaultPrevented)
        return;
      switch (this.constructor.keyboardMode) {
        case "tablist":
...
var a = class extends HTMLElement {
  ...
  K(t4, i5) {
    ...
    if (n7 !== void 0 && this.\u03A0h !== n7) {
      const t5 = r5.getPropertyOptions(n7), l5 = t5.converter, a4 = (h4 = (e6 = (s5 = l5) === null || s5 === void 0 ? void 0 : s5.fromAttribute) !== null && e6 !== void 0 ? e6 : typeof l5 == "function" ? l5 : null) !== null && h4 !== void 0 ? h4 : o4.fromAttribute;
...
var V = (t4, i5, s5) => {
  var e6, o7;
  const l5 = (e6 = s5 == null ? void 0 : s5.renderBefore) !== null && e6 !== void 0 ? e6 : i5;
  let n7 = l5._$litPart$;
  if (n7 === void 0) {
    const t5 = (o7 = s5 == null ? void 0 : s5.renderBefore) !== null && o7 !== void 0 ? o7 : null;
    l5._$litPart$ = n7 = new C(i5.insertBefore(c(), t5), t5, void 0, s5);
  }
  return n7.I(t4), n7;
};
...
var M = (t4, i5) => {
  ...
  for (let i6 = 0; i6 < s5; i6++) {
    ...
    for (; v2 < s6.length && (u3.lastIndex = v2, c3 = u3.exec(s6), c3 !== null); )
      v2 = u3.lastIndex, u3 === f ? c3[1] === "!--" ? u3 = _ : c3[1] !== void 0 ? u3 = m : c3[2] !== void 0 ? (y.test(c3[2]) && (o7 = RegExp("</" + c3[2], "g")), u3 = p) : c3[3] !== void 0 && (u3 = p) : u3 === p ? c3[0] === ">" ? (u3 = o7 != null ? o7 : f, d2 = -1) : c3[1] === void 0 ? d2 = -2 : (d2 = u3.lastIndex - c3[2].length, l5 = c3[1], u3 = c3[3] === void 0 ? p : c3[3] === '"' ? g : $) : u3 === g || u3 === $ ? u3 = p : u3 === _ || u3 === m ? u3 = f : (u3 = p, o7 = void 0);
    const a4 = u3 === p && t4[i6 + 1].startsWith("/>") ? " " : "";
    h4 += u3 === f ? s6 + r4 : d2 >= 0 ? (e6.push(l5), s6.slice(0, d2) + "$lit$" + s6.slice(d2) + n5 + a4) : s6 + n5 + (d2 === -2 ? (e6.push(void 0), i6) : a4);
  }
          ...
          for (const i6 of e6.getAttributeNames())
            if (i6.endsWith("$lit$") || i6.startsWith(n5)) {
              ...
              if (t5.push(i6), s6 !== void 0) {
                ...
                d2.push({ type: 1, index: l5, name: i7[2], strings: t6, ctor: i7[1] === "." ? I : i7[1] === "?" ? L : i7[1] === "@" ? R : H });
              } else
                d2.push({ type: 6, index: l5 });
            }
          for (const i6 of t5)
        ...
        if (y.test(e6.tagName)) {
          ...
          if (i6 > 0) {
            ...
            for (let s6 = 0; s6 < i6; s6++)
              e6.append(t5[s6], c()), E.nextNode(), d2.push({ type: 2, index: ++l5 });
            e6.append(t5[i6], c());
          }
        }
      } else if (e6.nodeType === 8)
        if (e6.data === h2)
          d2.push({ type: 2, index: l5 });
        else {
          let t5 = -1;
          for (; (t5 = e6.data.indexOf(n5, t5 + 1)) !== -1; )
            d2.push({ type: 7, index: l5 }), t5 += n5.length - 1;
        }
      l5++;
    }
  }
...
function S2(t4, i5, s5 = t4, e6) {
  ...
  return (r5 == null ? void 0 : r5.constructor) !== u3 && ((l5 = r5 == null ? void 0 : r5.O) === null || l5 === void 0 || l5.call(r5, false), u3 === void 0 ? r5 = void 0 : (r5 = new u3(t4), r5.T(t4, s5, e6)), e6 !== void 0 ? ((n7 = (h4 = s5).\u03A3i) !== null && n7 !== void 0 ? n7 : h4.\u03A3i = [])[e6] = r5 : s5.\u03A3o = r5), r5 !== void 0 && (i5 = S2(t4, r5.S(t4, i5.values), r5, e6)), i5;
}
var k = class {
  constructor(t4, i5) {
  ...
  u(t4) {
    ...
    E.currentNode = o7;
    let l5 = E.nextNode(), n7 = 0, h4 = 0, r5 = e6[0];
    for (; r5 !== void 0; ) {
      if (n7 === r5.index) {
        let i6;
        r5.type === 2 ? i6 = new C(l5, l5.nextSibling, this, t4) : r5.type === 1 ? i6 = new r5.ctor(l5, r5.name, r5.strings, this, t4) : r5.type === 6 && (i6 = new z(l5, this, t4)), this.l.push(i6), r5 = e6[++h4];
      }
      n7 !== (r5 == null ? void 0 : r5.index) && (l5 = E.nextNode(), n7++);
    }
    return o7;
  }
  v(t4) {
...
var H = class {
  ...
  I(t4, i5 = this, s5, e6) {
    ...
    let l5 = false;
    if (o7 === void 0)
      t4 = S2(this, t4, i5, 0), l5 = !d(t4) || t4 !== this.H && t4 !== w, l5 && (this.H = t4);
    else {
      const e7 = t4;
      let n7, h4;
      for (t4 = o7[0], n7 = 0; n7 < o7.length - 1; n7++)
        h4 = S2(this, e7[s5 + n7], i5, n7), h4 === w && (h4 = this.H[n7]), l5 || (l5 = !d(h4) || h4 !== this.H[n7]), h4 === A ? t4 = A : t4 !== A && (t4 += (h4 != null ? h4 : "") + o7[n7 + 1]), this.H[n7] = h4;
    }
    l5 && !e6 && this.W(t4);
  }
  W(t4) {
...
var R = class extends H {
  ...
  I(t4, i5 = this) {
    ...
    if ((t4 = (s5 = S2(this, t4, i5, 0)) !== null && s5 !== void 0 ? s5 : A) === w)
      return;
    const e6 = this.H, o7 = t4 === A && e6 !== A || t4.capture !== e6.capture || t4.once !== e6.once || t4.passive !== e6.passive, l5 = t4 !== A && (e6 === A || o7);
    o7 && this.element.removeEventListener(this.name, this, e6), l5 && this.element.addEventListener(this.name, this, t4), this.H = t4;
  }
  handleEvent(t4) {
    var i5, s5;
...
var l4 = (l5) => l5 != null ? l5 : A;

// node_modules/rocket-preset-code-tabs/components/code-tabs.ts
import "./code-copy.js";

// node_modules/rocket-preset-code-tabs/components/button-host.css
var styles = i2`:host {
  display: block;
  position: relative;
...
`;
var button_host_default = styles;

// node_modules/rocket-preset-code-tabs/components/code-tabs.css
var styles2 = i2`:host {
...
`;
var code_tabs_default = styles2;

// node_modules/rocket-preset-code-tabs/components/code-tab.css
var styles3 = i2`:host(:not([selected])) {
  display: none;
}
...
var CodeTabs = class extends SelectMixin(h3) {
    ...
    return T`
      <div id="tabs" role="tablist" part="tablist">
        ...
        <button role="tab"
                ...
                data-id="${id}"
                id="button-${id}"
                aria-selected="${this.selectedIndex === i5}"
                aria-controls="${id}"
                tabindex="${this.selectedIndex === i5 || this.selectedIndex < 0 && i5 === 0 ? 0 : -1}"
                ?selected="${this.selectedIndex === i5}"
                @click="${this.onClickTab}">
          <img src="${l4(iconHref)}" role="presentation"/>
          ${label}
        </button>
        `)}
      </div>
      ...
      <div id="sr-clone">${Array.from(this.children, (node, i5) => T`
        <div id="${node.dataset.id}"
             role="tabpanel"
             aria-labelledby="button-${node.dataset.id}"
             ?hidden="${this.selectedIndex !== i5}">
          ${Array.from(node.children, (x2) => {
      const clone = x2.cloneNode(true);
  ...
  initLabels(event) {
    ...
    this.items.forEach(({ dataset: { id, label, iconHref, ...dataset } }) => {
      const pkg = { id, label, iconHref };
      this.labels.set(pkg.id, pkg);
    });
  }
};
CodeTabs.allowedChildren = ["code-tab"];
CodeTabs.styles = [button_host_default, code_tabs_default];
CodeTabs.keyboardMode = "tablist";
__decorateClass([
  r()
...
var CodeTab = class extends h3 {
  ...
  render() {
    if (this.noCopy)
      return T`<div part="content"><slot></slot></div>`;
    else
      return T`<code-copy part="content" .host=${this}><slot></slot></code-copy>`;
  }
};
CodeTab.styles = [code_tab_default];
__decorateClass([
  e()
